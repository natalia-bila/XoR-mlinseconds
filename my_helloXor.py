...
from mlis.utils import solutionmanager as sm
...
class Solution():
    def __init__(self):
        ...
        self.learning_rate_grid = [0.5,1,2,3,4,5]
        self.hidden_size_grid = [3,4,5,6,7,8]
    ...
    def train_model(self, train_data, train_target, context):
        ...
        optimizer = optim.SGD(model.parameters(), lr=self.learning_rate, momentum=0.7)
        while True:
